...
export const ServerSearch = ({
  ...
  return (
    <>
    <button onClick = {() => setOpen(true)} className="group px-2 py-2 rounden-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition">
